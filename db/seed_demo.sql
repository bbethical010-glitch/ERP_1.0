...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000001', 'Stock-in-Hand', 'CA-STOCK', 'CURRENT_ASSET', (SELECT id FROM account_groups WHERE business_id = '00000000-0000-0000-0000-000000000001' AND code = 'CA'), TRUE),
...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000001', (SELECT id FROM account_groups WHERE business_id = '00000000-0000-0000-0000-000000000001' AND code = 'CA-STOCK'), 'A-STOCK', 'Stock-in-Hand', 'DR', 0, 'DR', TRUE),
